            ...
            <template v-slot:body="props">
                <q-tr :props="props">
                    ...
                    <q-td key="actions" :props="props">
                        ...
                        <q-btn @click="deleteProduct(props.row.id)" color="negative" icon="delete" dense flat />
                    </q-td>
                </q-tr>
            </template>
        </q-table>
        ...
        <q-dialog v-model="showProductActionDialog" persistent>
            <q-card flat>
                <q-card-section>
                    ...
                    <q-input v-model="productInfo.retail" label="Retail Price" type="number" />
                    <q-input v-model="productInfo.resell" label="Resell Price" type="number" />
                    <q-input v-model="productInfo.quantity" label="Quantity" type="number" />
                </q-card-section>
                <q-card-actions align="right">
                    <q-btn flat label="Cancel" color="negative" @click="cancelAddProduct" />
                    <q-btn flat :label="isEditMode ? 'Save' : 'Add'" color="primary"
